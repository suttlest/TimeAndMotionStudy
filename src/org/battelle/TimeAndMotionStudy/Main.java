...
public class Main extends Activity {
	...
	private boolean MenuChoice(MenuItem item) {
		...
		case 0:
			Intent configureIntent = new Intent(this, Configure.class);
			startActivity(configureIntent);
			return true;
		case 1:
			Toast.makeText(this, "This should take you to another ?Activity? to view data logs",Toast.LENGTH_LONG).show();
			return true;
		case 2:
			Toast.makeText(this, "This should take you to another ?Activity? to view data summary graphs",Toast.LENGTH_LONG).show();
			return true;
		}
		return false;
